classdef Bass_Playlist_MakerApp < handle
%
% Usage:
%     app.Bass_Playlist_MakerApp

  properties
      AppPath = {'/Bass_Playlist_Maker/code'};
	  AppClass = 'Bass_Playlist_MakerApp';
	  AppHandle;
	  AppCount = 0;
      Increment = 1;
	  Decrement = 0;
  ...
  methods
    ...
    function obj = Bass_Playlist_MakerApp()      
    ...
    function startApp(obj)
        ...
        if nargout(@Bass_Playlist_maker) == 0  
            eval('Bass_Playlist_maker');
        else
			obj.AppHandle = eval('Bass_Playlist_maker');   
        end 
        % Increment the reference count by one    
        Bass_Playlist_MakerApp.refcount(obj.Increment);
