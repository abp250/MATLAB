function varargout = GUI_nine(varargin)
% GUI_nine MATLAB code for GUI_compact.fig
%      GUI_nine, by itself, creates a new GUI_nine or raises the existing
%      singleton*.
%
%      H = GUI_nine returns the handle to a new GUI_nine or the handle to
%      the existing singleton*.
%
%      GUI_nine('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_nine.M with the given input arguments.
%
%      GUI_nine('Property','Value',...) creates a new GUI_nine or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI_nine before GUI_nine_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_nine_OpeningFcn via varargin.
%
%      *See GUI_nine Options on GUIDE's Tools menu.  Choose "GUI_nine allows only one
%      instance to run (singleton)".
%
% See also: GUIDE, GUIDATA, GUIHANDLES

% Edit the above text to modify the response to help GUI_nine

% Last Modified by GUIDE v2.5 09-Jun-2015 10:41:10

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_nine_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_nine_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_nine is made visible.
function GUI_nine_OpeningFcn(hObject, eventdata, handles, varargin)
% MATLAB auto-generated comments ---------------------------
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_nine (see VARARGIN)

% Choose default command line output for GUI_nine
handles.output = hObject;

handles.filepath = hObject;
handles.filepath = mfilename('fullpath');
handles.filepath = strrep(handles.filepath, 'GUI_nine', '');
...
function varargout = GUI_nine_OutputFcn(hObject, eventdata, handles) 
...
% executes when the GUI_nine is closed either by command from matlab terminal or
% with the operating system x on the top right of the GUI_nine.
% MATLAB auto-generated comments ---------------------------
...
% --- Plots all current fields stored in main on the GUI_nine preview plot axes
...
% use in the GUI_nine callbacks.
% My format:
%   all of these fields are stored in handles.main.expData can not be
%   stored in handles because this is a non-GUI_nine function and it will be
...
% it also changes the format back to it's original by removing the GUI_nine data
% will update the structure to the settings that have been changed by the GUI_nine
...
% --- Changes all GUI_nine objects to be consistent with current options
function handles = loadOptions(hObject, eventdata, handles)
% this is for a situation where a user opens the GUI_nine when there have been
% options already set. This function will set the GUI_nine objects so that it
